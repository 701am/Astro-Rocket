...
// 701am setup flow: clone → install → dev
const script: ScriptLine[] = [
  // Step 1: clone
  { text: '$ git clone https://github.com/your-org/701am.git', delay: 1200, type: 'command' },
  { text: '', delay: 200, type: 'command' },
  { text: 'Cloning into \'701am\'...', delay: 300, type: 'prompt-hint' },
  { text: '✔  Repository cloned', delay: 600, type: 'success' },
  { text: '', delay: 200, type: 'prompt-label' },

  // Step 2: install
  { text: '$ cd 701am && pnpm install', delay: 600, type: 'command' },
  { text: '', delay: 200, type: 'command' },
